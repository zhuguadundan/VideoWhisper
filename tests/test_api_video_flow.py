...
def test_process_video_success_flow_spawns_task(client, monkeypatch):
    ...
    monkeypatch.setattr(main.video_processor, "create_task", lambda url, youtube_cookies=None: "task-123")
    monkeypatch.setattr(main.video_processor, "process_video", lambda *args, **kwargs: None)
...
def test_get_progress_returns_data(client, monkeypatch):
    ...
    monkeypatch.setattr(main.video_processor, "get_task_progress", fake_get_task_progress)
