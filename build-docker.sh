...
echo -e "${BLUE}   - API health check: curl http://localhost:5000/api/health${NC}"
echo -e "${BLUE}   - HTTPS health check: curl -k https://localhost:5443/api/health${NC}"
echo ""
echo -e "${CYAN}🚀 Quick test commands:${NC}"
echo -e "${YELLOW}   # Test HTTP${NC}"
echo -e "${YELLOW}   curl -f http://localhost:5000/api/health || echo 'HTTP failed'${NC}"
echo ""
echo -e "${YELLOW}   # Test HTTPS${NC}"
echo -e "${YELLOW}   curl -k -f https://localhost:5443/api/health || echo 'HTTPS failed'${NC}"
echo ""
